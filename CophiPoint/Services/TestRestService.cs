...
namespace CophiPoint.Services
{
    public class TestRestService:IOrderService, IProductService
    {
        ...
        public Task<AccountInfo> GetAccountInfo() => Task.FromResult(new AccountInfo
        {
